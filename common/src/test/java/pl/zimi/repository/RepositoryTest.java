...
public class RepositoryTest {
    ...
    List<DynamicTest> repositoryTest() {
        final Contract<Foo> contract = Contract.repository(Foo.class).id(SFoo.foo.id).version(SFoo.foo.version).sortingFeature(true).regexFeature(true).offsetFeature(true);
